...
let main ({utf8; colored; i3bar; n; volume_provider} as cfg) old_state = begin
  let (module Data) = volume_provider in
  let rec aux (utf8, colored, i3bar, n) old_state =
      Data.read_volume
      ...
      flush_all ();
      aux (utf8, colored, i3bar, n) (Some {status = stat; volume = [|vol_lft; vol_rgt|]}); (* pretty sure this is a tailcall *)
  in
  aux (utf8, colored, i3bar, n) old_state
end
